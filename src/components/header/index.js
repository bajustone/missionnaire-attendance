...
class Header {
	...
	render(props, { }) {
		...
		let menuNav = <Link activeClassName={style.active} href="/list">Urutonde rwose</Link>;
		...
		return (<header className={style.header}>
			<div className={style.headerContents}>
				...
				<nav>
					{user ? <Link activeClassName={style.active} href="/attended">Urutonde rw'abateranye</Link> : ""}
